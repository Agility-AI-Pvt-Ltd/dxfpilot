...
class DesignIntent(BaseModel):
    ...
    # design-basis values a reviewer approved where the workbooks disagree: parameter id -> Approval dict
    basis_approvals: dict[str, dict] = Field(default_factory=dict)
