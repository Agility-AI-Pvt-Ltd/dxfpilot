...
# and the coverage report: rows / sections / products of the design data that this drawing leaves out
KNOWN_DATA_WARNINGS = {"UNDERSIZED", "ROWS_NOT_DRAWN", "SECTION_NOT_COVERED", "PRODUCT_NOT_COVERED", "BASIS_CONFLICT"}
...
def test_ten_modules_are_defined_with_their_own_rules():
    assert ALL[:10] == ["reception", "pasteurization", "cip", "steam", "hot_water", "chilled_water", "curd", "ghee", "cream", "packaging"]
    assert "paneer" in ALL
