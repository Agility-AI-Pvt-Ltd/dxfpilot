        ...
        <div className="field">
          ...
          {engine === "llm_planner" && (
            <span style={{ fontSize: 12.5, color: "var(--ink-2)" }}>
              ...
              (up to 10 attempts; only the sections that still have errors are sent back). If it still fails, the best version comes to you for review instead of looping.
            </span>
          )}
        </div>
